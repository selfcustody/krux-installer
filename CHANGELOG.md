...
- Update outdated deps: `kivy`, `cryptography`, `black`, `poethepoet` and
  their subdependencies;
- Add Nix compatibility;
- Add TZT device support;
- Add Embed Fire device support;
- Increase delay between requests;
- Rename `krux-installer.py` to `krux_installer.py` for Poetry
  compatibility;
- Fix E2E test race conditions in CI;
- Update build actions;
- Update repository URL in README;
- Update to Python 3.14 and bump `pysudoer`;
