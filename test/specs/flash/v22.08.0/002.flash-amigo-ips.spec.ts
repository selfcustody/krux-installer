...
describe('WriteToDevicePage: write firmware official v22.08.0 to amigo_ips', () => {
  ...
  // eslint-disable-next-line no-undef
  it('should show subtitle \'device: maixpy_amigo_ips\'', async () => {   
    await expectWDIO(BeforeFlash.cardSubtitleDevice).toHaveText('device: maixpy_amigo_ips')
  })
