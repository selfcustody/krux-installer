...
describe('WriteToDevicePage: write firmware official v22.08.0 to amigo_tft', () => {
  ...
  // eslint-disable-next-line no-undef
  it('should show subtitle \'version: selfcustody/krux/releases/tag/v22.08.0\'', async () => {   
    await expectWDIO(BeforeFlash.cardSubtitleVersion).toHaveText('version: selfcustody/krux/releases/tag/v22.08.0')
  })
  
  // eslint-disable-next-line no-undef
  it('should show subtitle \'device: maixpy_amigo_tft\'', async () => {   
    await expectWDIO(BeforeFlash.cardSubtitleDevice).toHaveText('device: maixpy_amigo_tft')
  })
