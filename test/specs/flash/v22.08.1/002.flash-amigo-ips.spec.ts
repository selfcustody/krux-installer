...
describe('WriteToDevicePage: write firmware official v22.08.1 to amigo_ips', () => {
  ...
  // eslint-disable-next-line no-undef
  it('should show subtitle \'version: selfcustody/krux/releases/tag/v22.08.1\'', async () => {   
    await expectWDIO(BeforeFlash.cardSubtitleVersion).toHaveText('version: selfcustody/krux/releases/tag/v22.08.1')
  })
