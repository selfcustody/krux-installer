...
describe('WriteToDevicePage: write firmware official v22.08.1 to dock', () => {
  ...
  // eslint-disable-next-line no-undef
  it('should show subtitle \'device: maixpy_dock\'', async () => {   
    await expectWDIO(BeforeFlash.cardSubtitleDevice).toHaveText('device: maixpy_dock')
  })
