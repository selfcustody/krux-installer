...
describe('WriteToDevicePage: write firmware official v22.08.2 to amigo_tft', () => {
  ...
  // eslint-disable-next-line no-undef
  it('should show subtitle \'version: selfcustody/krux/releases/tag/v22.08.2\'', async () => {   
    await expectWDIO(BeforeFlash.cardSubtitleVersion).toHaveText('version: selfcustody/krux/releases/tag/v22.08.2')
  })
