...
describe('WriteToDevicePage: write firmware official v22.08.2 to bit', () => {
  ...
  // eslint-disable-next-line no-undef
  it('should show subtitle \'device: maixpy_bit\'', async () => {   
    await expectWDIO(BeforeFlash.cardSubtitleDevice).toHaveText('device: maixpy_bit')
  })
