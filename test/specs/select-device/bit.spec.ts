...
describe('SelectDevicePage: page select \'bit\' option', () => {
  ...
  it('should be selected', async () => {    
    await expectWDIO(SelectDevice.formSelected).toHaveText('maixpy_bit')
  })
  ...
  it('should the \'select device\' changed to \'maixpy_bit\'', async () => {  
    ...
    await expectWDIO(deviceButtonContent).toHaveText('MAIXPY_BIT')
  })    
})
