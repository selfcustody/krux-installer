...
describe('SelectVersionPage: check for \'odudex/krux_binaries/raw/main/maixpy_amigo_ips/firmware.bin\'', () => {
  ...
  // eslint-disable-next-line no-undef
  it('should title be \'Checking for maixpy_amigo_ips firmware.bin...\'', async () => { 
    await expectWDIO(CheckResourcesTestFirmware.cardTitleChecking).toHaveText('Checking for maixpy_amigo_ips firmware.bin...')
  })
