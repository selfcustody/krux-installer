...
describe('SelectVersionPage: download \'odudex/krux_binaries/raw/main/maixpy_amigo_ips/firmware.bin\'', () => {
  ...
  it('should card subtitle be \'device: maixpy_amigo_ips\'', async () => {  
    ...
    await expectWDIO(DownloadTestFirmware.cardSubtitle).toHaveText('device: maixpy_amigo_ips')
  })
