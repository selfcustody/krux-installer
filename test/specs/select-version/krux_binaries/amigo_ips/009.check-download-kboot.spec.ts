...
describe('check downloaded \'odudex/krux_binaries/raw/main/maixpy_amigo_ips/kboot.kfpkg\' on file system', () => {
  ...
  before(async () => {
    ...
    kboot = join(api.documents, name, 'odudex', 'krux_binaries', 'raw', 'main', 'maixpy_amigo_ips', 'kboot.kfpkg') 
  })
  ...
  it('should downloaded kboot file on disk have correct size', async () => {
    ...
    expectChai(bytes).to.be.equal('896.25 KB')
  })
})
