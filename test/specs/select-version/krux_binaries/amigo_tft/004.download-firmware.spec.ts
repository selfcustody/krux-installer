...
describe('SelectVersionPage: download \'odudex/krux_binaries/raw/main/maixpy_amigo_tft/firmware.bin\'', () => {
  ...
  // eslint-disable-next-line no-undef
  it('should card subtitle be \'device: maixpy_amigo_tft\'', async () => {  
    await DownloadTestFirmware.cardSubtitle.waitForExist()
    await expectWDIO(DownloadTestFirmware.cardSubtitle).toHaveText('device: maixpy_amigo_tft')
  })
