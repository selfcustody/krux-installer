...
describe('check downloaded \'odudex/krux_binaries/raw/main/maixpy_dock/firmware.bin\' on file system', () => {
  ...
  before(async () => {
    ...
    firmware = join(api.documents, name, 'odudex', 'krux_binaries', 'raw', 'main', 'maixpy_dock', 'firmware.bin') 
  })
