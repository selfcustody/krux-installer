...
describe('SelectVersionPage: warn before download \'odudex/krux_binaries/raw/main/maixpy_dock/firmware.bin\' again', () => {
  ...
  // eslint-disable-next-line no-undef
  it('should card title be \'odudex/krux_binaries/raw/main/maixpy_dock/firmware.bin\'', async () => {
    await expectWDIO(CheckResourcesTestFirmware.cardTitleChecked).toHaveText('odudex/krux_binaries/raw/main/maixpy_dock/firmware.bin')
  })
