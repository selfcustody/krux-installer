...
describe('SelectVersionPage: check \'odudex/krux_binaries/raw/main/maixpy_dock/kboot.kfpkg\'', () => {
  ...
  // eslint-disable-next-line no-undef
  it('should card title be \'Checking for maixpy_dock kboot.kfpkg...\'', async () => {
    await expectWDIO(CheckResourcesTestKboot.cardTitleChecking).toHaveText('Checking for maixpy_dock kboot.kfpkg...')
  })
})
