...
describe('SelectVersionPage: download \'odudex/krux_binaries/raw/main/maixpy_dock/kboot.kfpkg\'', () => {
  ...
  // eslint-disable-next-line no-undef
  it('should card title be \'odudex/krux_binaries/raw/main/maixpy_dock/kboot.kfpkg\'', async () => {
    await expectWDIO(CheckResourcesTestKboot.cardTitleChecked).toHaveText('odudex/krux_binaries/raw/main/maixpy_dock/kboot.kfpkg')
  })
