...
describe('SelectVersionPage: download \'selfcustody/krux/releases/tag/v22.08.0\' option', () => {
  ...
  // eslint-disable-next-line no-undef
  it('should card subtitle be \'selfcustody/krux/releases/download/v22.08.0/krux-v22.03.0.zip\'', async () => {  
    await DownloadOfficialRelease.cardSubtitle.waitForExist()
    await expectWDIO(DownloadOfficialRelease.cardSubtitle).toHaveText('selfcustody/krux/releases/download/v22.08.0/krux-v22.08.0.zip')
  })
