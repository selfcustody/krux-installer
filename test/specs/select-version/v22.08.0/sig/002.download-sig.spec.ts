...
describe('SelectVersionPage: download \'v22.08.0/krux-v22.08.0.zip.sig\' option', () => {
  ...
  // eslint-disable-next-line no-undef
  it('should card subtitle be \'selfcustody/krux/releases/download/v22.08.0/krux-v22.08.0.zip.sig\'', async () => {  
    await DownloadOfficialReleaseSig.cardSubtitle.waitForExist()
    await expectWDIO(DownloadOfficialReleaseSig.cardSubtitle).toHaveText('selfcustody/krux/releases/download/v22.08.0/krux-v22.08.0.zip.sig...')
  })
