...
describe('Start verification of \'v22.08.0/krux-v22.08.0.zip\' release', () => {
  ...
  // eslint-disable-next-line no-undef
  it('should card title be \'Verifying release v22.08.0...\'', async () => {
    await expectWDIO(VerifyOfficialRelease.cardTitleChecking).toHaveText('Verifying release v22.08.0...')
  })
