...
describe('Verified \'v22.08.0/krux-v22.08.0.zip\' release sucessfully', () => {
  ...
  // eslint-disable-next-line no-undef
  it('should card have a text \'Filename: v22.08.0/krux-v22.08.0.zip.sha256.txt\'', async () => {
    await expectWDIO(VerifyOfficialRelease.cardContentFilenameTxt).toHaveText('Filename: v22.08.0/krux-v22.08.0.zip.sha256.txt')
  })

  // eslint-disable-next-line no-undef
  it('should card have a text \'Filename: v22.08.0/krux-v22.08.0.zip\'', async () => {
    await expectWDIO(VerifyOfficialRelease.cardContentFilenameSha256).toHaveText('Filename: v22.08.0/krux-v22.08.0.zip')
  })

  // eslint-disable-next-line no-undef
  it('should card have txt chip with correct hash', async () => {
    await expectWDIO(VerifyOfficialRelease.chipHashTxt).toHaveText('a6d06a93e7dcd25f3061f39c3166f9a18c7e53bf3ccfb86d554eb63bd6a2d3a0')
  })

  // eslint-disable-next-line no-undef
  it('should card have sha256sum chip with correct hash', async () => {
    await expectWDIO(VerifyOfficialRelease.chipHashSha256).toHaveText('a6d06a93e7dcd25f3061f39c3166f9a18c7e53bf3ccfb86d554eb63bd6a2d3a0')
  })
  ...
  it('should card have a console with complete command used to verify', async () => {
    ...
    await expectWDIO(VerifyOfficialRelease.consoleSignatureCommand).toHaveText([
      ...
      'openssl',
      'sha256',
      `<${docs}/krux-installer/v22.08.0/krux-v22.08.0.zip`,
      '-binary',
      '|',
      'openssl',
      'pkeyutl',
      ...
      '-sigfile',
      `${docs}/krux-installer/v22.08.0/krux-v22.08.0.zip.sig`
    ].join(' '))
  })
