...
describe('Unzip \'v22.08.0/krux-v22.08.0.zip\' release', () => {
  ...
  describe('list items', () => {
    ...
    // eslint-disable-next-line no-undef
    it('should have listed \'krux-v22.08.0/maixpy_bit/firmware.bin.sig  \'', async () => {
      await expectWDIO(childs[0]).toHaveText('krux-v22.08.0/maixpy_bit/firmware.bin.sig')
    })

    // eslint-disable-next-line no-undef
    it('should have listed \'krux-v22.08.0/maixpy_bit/firmware.bin\'', async () => {
      await expectWDIO(childs[1]).toHaveText('krux-v22.08.0/maixpy_bit/firmware.bin')
    })

    // eslint-disable-next-line no-undef
    it('should have listed \'krux-v22.08.0/maixpy_bit/kboot.kfpkg\'', async () => {
      await expectWDIO(childs[2]).toHaveText('krux-v22.08.0/maixpy_bit/kboot.kfpkg')
    })

    // eslint-disable-next-line no-undef
    it('should have listed \'krux-v22.08.0/ktool-win.exe\'', async () => {
      await expectWDIO(childs[3]).toHaveText('krux-v22.08.0/ktool-win.exe')
    })

    // eslint-disable-next-line no-undef
    it('should have listed \'krux-v22.08.0/ktool-mac-10\'', async () => {
      await expectWDIO(childs[4]).toHaveText('krux-v22.08.0/ktool-mac-10')
    })

    // eslint-disable-next-line no-undef
    it('should have listed \'krux-v22.08.0/ktool-mac\'', async () => {
      await expectWDIO(childs[5]).toHaveText('krux-v22.08.0/ktool-mac')
    })

    // eslint-disable-next-line no-undef
    it('should have listed \'krux-v22.08.0/maixpy_amigo_tft/firmware.bin.sig \'', async () => {
      await expectWDIO(childs[6]).toHaveText('krux-v22.08.0/maixpy_amigo_tft/firmware.bin.sig')
    })

    // eslint-disable-next-line no-undef
    it('should have listed \'krux-v22.08.0/maixpy_amigo_tft/firmware.bin\'', async () => {
      await expectWDIO(childs[7]).toHaveText('krux-v22.08.0/maixpy_amigo_tft/firmware.bin')
    })

    // eslint-disable-next-line no-undef
    it('should have listed \'krux-v22.08.0/maixpy_amigo_tft/kboot.kfpkg\'', async () => {
      await expectWDIO(childs[8]).toHaveText('krux-v22.08.0/maixpy_amigo_tft/kboot.kfpkg')
    })

    // eslint-disable-next-line no-undef
    it('should have listed \'krux-v22.08.0/maixpy_m5stickv/firmware.bin.sig\'', async () => {
      await expectWDIO(childs[9]).toHaveText('krux-v22.08.0/maixpy_m5stickv/firmware.bin.sig')
    })

    // eslint-disable-next-line no-undef
    it('should have listed \'krux-v22.08.0/maixpy_m5stickv/firmware.bin\'', async () => {
      await expectWDIO(childs[10]).toHaveText('krux-v22.08.0/maixpy_m5stickv/firmware.bin')
    })

    // eslint-disable-next-line no-undef
    it('should have listed \'krux-v22.08.0/maixpy_m5stickv/kboot.kfpkg \'', async () => {
      await expectWDIO(childs[11]).toHaveText('krux-v22.08.0/maixpy_m5stickv/kboot.kfpkg')
    })

    // eslint-disable-next-line no-undef
    it('should have listed \'krux-v22.08.0/ktool-linux\'', async () => {
      await expectWDIO(childs[12]).toHaveText('krux-v22.08.0/ktool-linux')
    })

    // eslint-disable-next-line no-undef
    it('should have listed \'krux-v22.08.0/maixpy_amigo_ips/firmware.bin.sig\'', async () => {
      await expectWDIO(childs[13]).toHaveText('krux-v22.08.0/maixpy_amigo_ips/firmware.bin.sig')
    })

    // eslint-disable-next-line no-undef
    it('should have listed \'krux-v22.08.0/maixpy_amigo_ips/firmware.bin\'', async () => {
      await expectWDIO(childs[14]).toHaveText('krux-v22.08.0/maixpy_amigo_ips/firmware.bin')
    })
    
    // eslint-disable-next-line no-undef
    it('should have listed \'krux-v22.08.0/maixpy_amigo_ips/kboot.kfpkg\'', async () => {
      await expectWDIO(childs[15]).toHaveText('krux-v22.08.0/maixpy_amigo_ips/kboot.kfpkg')
    })
 
    // eslint-disable-next-line no-undef
    it('should have listed \'krux-v22.08.0/maixpy_dock/firmware.bin.sig\'', async () => {
      await expectWDIO(childs[16]).toHaveText('krux-v22.08.0/maixpy_dock/firmware.bin.sig')
    })

    // eslint-disable-next-line no-undef
    it('should have listed \'krux-v22.08.0/maixpy_dock/firmware.bin\'', async () => {
      await expectWDIO(childs[17]).toHaveText('krux-v22.08.0/maixpy_dock/firmware.bin')
    })

    // eslint-disable-next-line no-undef
    it('should have listed \'krux-v22.08.0/maixpy_dock/kboot.kfpkg\'', async () => {
      await expectWDIO(childs[18]).toHaveText('krux-v22.08.0/maixpy_dock/kboot.kfpkg')
    })
  ...
  describe('click \'DONE\' and verify button on MainPage', () => {
    ...
    // eslint-disable-next-line no-undef
    it('should button changed from \'SELECT VERSION\' to \'SELFCUSTODY/KRUX/RELEASE/TAG/V22.08.0\' on MainPage', async () => {
      await expectWDIO(Main.selectVersionButton).toHaveText('SELFCUSTODY/KRUX/RELEASES/TAG/V22.08.0')
    })
  })
})
