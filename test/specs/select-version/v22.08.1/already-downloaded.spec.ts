...
describe('SelectVersionPage: warn before download \'selfcustody/krux/releases/tag/v22.08.1\' again', () => {
  ...
  // eslint-disable-next-line no-undef
  it('should card title be \'v22.03.0/krux-v22.08.1.zip\'', async () => {
    await expectWDIO(CheckResourcesOfficialRelease.cardTitleChecked).toHaveText('v22.08.1/krux-v22.08.1.zip')
  })
