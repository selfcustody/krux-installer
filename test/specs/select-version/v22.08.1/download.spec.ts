...
describe('SelectVersionPage: download \'selfcustody/krux/releases/tag/v22.08.1\' option', () => {
  ...
  // eslint-disable-next-line no-undef
  it('should card subtitle be \'selfcustody/krux/releases/download/v22.08.1/krux-v22.08.1.zip\'', async () => {  
    await DownloadOfficialRelease.cardSubtitle.waitForExist()
    await expectWDIO(DownloadOfficialRelease.cardSubtitle).toHaveText('selfcustody/krux/releases/download/v22.08.1/krux-v22.08.1.zip')
  })
