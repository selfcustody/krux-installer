...
describe('SelectVersionPage: page select \'selfcustody/krux/releases/tag/v22.08.1\' option', () => {
  ...
  it('should be selected', async () => {    
    ...
    await delay(1000)
    await expectWDIO(SelectVersion.formSelected).toHaveText('selfcustody/krux/releases/tag/v22.08.1')
    await delay(1000)
  })
  ...
  it('should the \'SELECT VERSION\' button not changed', async () => {  
    ...
    await expectWDIO(deviceButtonContent).not.toHaveText('SELFCUSTODY/KRUX/RELEASES/TAG/V22.08.1')
  })
})
