...
describe('check downloaded v22.08.1 zip release on file system', () => {
  ...
  before(async () => {
    ...
    dir = join(api.documents, name, 'v22.08.1') 
    zip = join(dir, 'krux-v22.08.1.zip')
  })
  ...
  it('should downloaded release zip file on disk have correct size', async () => {
    const zip = join(dir, 'krux-v22.08.1.zip')
