...
describe('SelectVersionPage: warn before download \'selfcustody/krux/releases/tag/v22.08.1.sha256.txt\' again', () => {
  ...
  // eslint-disable-next-line no-undef
  it('should card title be \'v22.08.1/krux-v22.08.1.zip.sha256.txt\'', async () => {
    await expectWDIO(CheckResourcesOfficialReleaseSHA256.cardTitleChecked).toHaveText('v22.08.1/krux-v22.08.1.zip.sha256.txt')
  })
