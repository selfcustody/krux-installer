...
describe('SelectVersionPage: warn before download \'selfcustody/krux/releases/tag/v22.08.1.sig\' again', () => {
  ...
  // eslint-disable-next-line no-undef
  it('should card title be \'v22.08.1/krux-v22.08.1.zip.sig\'', async () => {
    await expectWDIO(CheckResourcesOfficialReleaseSig.cardTitleChecked).toHaveText('v22.08.1/krux-v22.08.1.zip.sig')
  })
