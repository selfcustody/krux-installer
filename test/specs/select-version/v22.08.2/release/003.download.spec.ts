...
describe('SelectVersionPage: download \'selfcustody/krux/releases/tag/v22.08.2\' option', () => {
  ...
  // eslint-disable-next-line no-undef
  it('should card subtitle be \'selfcustody/krux/releases/download/v22.08.2/krux-v22.08.2.zip\'', async () => {  
    await DownloadOfficialRelease.cardSubtitle.waitForExist()
    await expectWDIO(DownloadOfficialRelease.cardSubtitle).toHaveText('selfcustody/krux/releases/download/v22.08.2/krux-v22.08.2.zip')
  })
