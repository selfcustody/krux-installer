...
describe('Verified \'v22.08.2/krux-v22.08.2.zip\' release sucessfully', () => {
  ...
  // eslint-disable-next-line no-undef
  it('should card have a text \'Filename: v22.08.2/krux-v22.08.2.zip.sha256.txt\'', async () => {
    await expectWDIO(VerifyOfficialRelease.cardContentFilenameTxt).toHaveText('Filename: v22.08.2/krux-v22.08.2.zip.sha256.txt')
  })

  // eslint-disable-next-line no-undef
  it('should card have a text \'Filename: v22.08.2/krux-v22.08.2.zip\'', async () => {
    await expectWDIO(VerifyOfficialRelease.cardContentFilenameSha256).toHaveText('Filename: v22.08.2/krux-v22.08.2.zip')
  })

  // eslint-disable-next-line no-undef
  it('should card have txt chip with correct hash', async () => {
    await expectWDIO(VerifyOfficialRelease.chipHashTxt).toHaveText('26f901a173902e76b4d84a95ee3d552451bc08f6a054e472d5a54e6236312763')
  })

  // eslint-disable-next-line no-undef
  it('should card have sha256sum chip with correct hash', async () => {
    await expectWDIO(VerifyOfficialRelease.chipHashSha256).toHaveText('26f901a173902e76b4d84a95ee3d552451bc08f6a054e472d5a54e6236312763')
  })
