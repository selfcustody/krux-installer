...
describe('Unzip \'v22.08.2/krux-v22.08.2.zip\' release', () => {
  ...
  describe('list items', () => {
    ...
    // eslint-disable-next-line no-undef
    it('should have listed \'krux-v22.08.2/maixpy_dock/kboot.kfpkg\'', async () => {
  ...
  describe('click \'DONE\' and verify button on MainPage', () => {
    ...
    // eslint-disable-next-line no-undef
    it('should button changed from \'SELECT VERSION\' to \'SELFCUSTODY/KRUX/RELEASE/TAG/V22.08.2\' on MainPage', async () => {
      await expectWDIO(Main.selectVersionButton).toHaveText('SELFCUSTODY/KRUX/RELEASES/TAG/V22.08.2')
    })
  })
})
