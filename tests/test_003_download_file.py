    ...
    def test_successfully_download_zip_file(self, mock_requests):
        ...
        mock_requests.get.assert_called_once_with(
            ...
            headers={
                ...
                'User-Agent': 'Mocked User-Agent 1.0.0',
